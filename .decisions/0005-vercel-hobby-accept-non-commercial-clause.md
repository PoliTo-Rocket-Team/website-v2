...
**Vercel Hobby, for the record:** free, no card, 100 GB bandwidth a month, functions up to 5 minutes, auto-deploy on push. Generous enough that traffic is not the concern here; the terms are.

**Hobby cannot bill us, and the horror stories are not about this plan.** Asked on 2026-09-18 whether Vercel quietly starts charging Hobby users later. It does not: there is no card on the plan, and Vercel's own Hobby docs say that past a usage limit "you will have to wait until 30 days have passed before you can use the feature again." The failure mode is the site going dark for up to a month, never a surprise invoice. The viral five-figure bills people remember came from Pro accounts, where overage is billed and a traffic spike or a denial-of-service run could ring it up; spend caps were added afterwards. If we are ever on Pro, set a spend cap on day one — but per the Decision above we leave rather than upgrade.

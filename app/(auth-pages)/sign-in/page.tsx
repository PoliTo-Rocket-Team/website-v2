        ...
        >
          ...
          <defs>
            <radialGradient id="paint0_radial_37_453-1" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(-804.109 -2036.8) rotate(64.9401) scale(6436.87 6304.81)">
              <stop stopColor="hsl(var(--background))"></stop>
              <stop offset="0.0833333" stopColor="hsl(var(--border))"></stop>
              <stop offset="0.364583" stopColor="hsl(var(--secondary))"></stop>
              <stop offset="0.658041" stopColor="hsl(var(--background))"></stop>
              <stop offset="0.798521" stopColor="hsl(var(--ring))"></stop>
              <stop offset="0.942708" stopColor="hsl(var(--background))"></stop>
            ...
            <radialGradient id="paint1_radial_37_453-1" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(201.6 -1080.02) rotate(64.9401) scale(6436.87 6304.81)">
              <stop stopColor="hsl(var(--background))"></stop>
              <stop offset="0.0833333" stopColor="hsl(var(--muted))"></stop>
              <stop offset="0.333803" stopColor="hsl(var(--accent))"></stop>
              <stop offset="0.658041" stopColor="hsl(var(--background))"></stop>
              <stop offset="0.798521" stopColor="hsl(var(--ring))"></stop>
              <stop offset="0.942708" stopColor="hsl(var(--background))"></stop>
              <stop offset="1" stopColor="hsl(var(--background))"></stop>
            ...
            <radialGradient id="paint2_radial_37_453-1" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(912.834 -811.021) rotate(64.9401) scale(6436.87 6304.81)">
              <stop stopColor="hsl(var(--background))"></stop>
              <stop offset="0.140625" stopColor="hsl(var(--primary))"></stop>
              <stop offset="0.333803" stopColor="hsl(var(--border))"></stop>
              <stop offset="0.658041" stopColor="hsl(var(--background))"></stop>
              <stop offset="0.798521" stopColor="hsl(var(--ring))"></stop>
              <stop offset="0.942708" stopColor="hsl(var(--background))"></stop>
              <stop offset="1" stopColor="hsl(var(--background))"></stop>
            ...
            <filter id="filter0_f_37_453-1">
              <feFlood floodOpacity="0" result="BackgroundImageFix"/>
              <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape"/>
              <feGaussianBlur stdDeviation="2" result="effect1_foregroundBlur_37_453"/>
            </filter>
          </defs>
        </svg>
      </div>
      
      <div className="mx-auto flex w-full my-auto flex-col justify-center space-y-6 sm:w-[350px] relative z-10">

...
('11111111-1111-1111-1111-111111111111', 'marco.rossi@studenti.polito.it', 'Marco', 'Rossi', 'Italy', 'Master', 'linkedin.com/in/marcorossi', 's123456', 'Computer Engineering', 1, '2023-01-10 10:00:00+01'::timestamptz, NULL, '{"drive": ["heads", "leads", "general"], "wiki": ["general"]}' ),
('22222222-2222-2222-2222-222222222222', 'giulia.ferrari@studenti.polito.it', 'Giulia', 'Ferrari', 'Italy', 'Bachelor', 'linkedin.com/in/giuliaferrari', 's234567', 'Electronic Engineering', 2, '2023-01-15 11:30:00+01'::timestamptz, NULL, '{"drive": ["heads", "leads", "general"], "wiki": ["general"]}'),
('33333333-3333-3333-3333-333333333333', 'alessandro.russo@studenti.polito.it', 'Alessandro', 'Russo', 'Italy', 'PhD', 'linkedin.com/in/alessandrorusso', 's345678', 'Mechanical Engineering', 3, '2023-02-01 09:15:00+01'::timestamptz, NULL, '{"drive": ["heads", "leads", "general"], "wiki": ["general"]}'),
('44444444-4444-4444-4444-444444444444', 'valentina.esposito@studenti.polito.it', 'Valentina', 'Esposito', 'Italy', 'Master', 'linkedin.com/in/valentinaesposito', 's456789', 'Management Engineering', 4, '2023-02-05 14:20:00+01'::timestamptz, NULL, '{"drive": ["heads", "leads", "general"], "wiki": ["general"]}'),
('55555555-5555-5555-5555-555555555555', 'luca.bianchi@studenti.polito.it', 'Luca', 'Bianchi', 'Italy', 'Bachelor', 'linkedin.com/in/lucabianchi', 's567890', 'Computer Science', 5, '2023-02-20 16:45:00+01'::timestamptz, NULL, '{"drive": ["heads", "leads", "general"], "wiki": ["general"]}'),
('66666666-6666-6666-6666-666666666666', 'sofia.ricci@studenti.polito.it', 'Sofia', 'Ricci', 'Italy', 'Master', 'linkedin.com/in/sofiaricci', 's678901', 'Data Science', 6, '2023-03-10 10:30:00+01'::timestamptz, NULL, '{"drive": ["heads", "leads", "general"], "wiki": ["general"]}'),
('77777777-7777-7777-7777-777777777777', 'matteo.conti@studenti.polito.it', 'Matteo', 'Conti', 'Italy', 'Bachelor', 'linkedin.com/in/matteoconti', 's789012', 'Electronic Engineering', 7, '2023-03-15 13:15:00+01'::timestamptz, NULL, '{"drive": ["heads", "leads", "general"], "wiki": ["general"]}'),
('88888888-8888-8888-8888-888888888888', 'elena.martini@studenti.polito.it', 'Elena', 'Martini', 'Italy', 'Master', 'linkedin.com/in/elenamartini', 's890123', 'Architecture', 8, '2023-04-05 11:45:00+02'::timestamptz, NULL, '{"drive": ["heads", "leads", "general"], "wiki": ["general"]}'),
('99999999-9999-9999-9999-999999999999', 'andrea.gallo@studenti.polito.it', 'Andrea', 'Gallo', 'Italy', 'PhD', 'linkedin.com/in/andreagallo', 's901234', 'Mechanical Engineering', 9, '2023-04-15 14:30:00+02'::timestamptz, NULL, '{"drive": ["heads", "leads", "general"], "wiki": ["general"]}'),
('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'francesca.leone@studenti.polito.it', 'Francesca', 'Leone', 'Italy', 'Bachelor', 'linkedin.com/in/francescaleone', 's012345', 'Energy Engineering', 10, '2023-04-25 09:20:00+02'::timestamptz, NULL, '{"drive": ["heads", "leads", "general"], "wiki": ["general"]}'),
('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'simone.lombardi@studenti.polito.it', 'Simone', 'Lombardi', 'Italy', 'Master', 'linkedin.com/in/simonelombardi', 's123457', 'Computer Engineering', 11, '2023-05-10 10:15:00+02'::timestamptz, NULL, '{"drive": ["heads", "leads", "general"], "wiki": ["general"]}'),
('cccccccc-cccc-cccc-cccc-cccccccccccc', 'claudia.marino@studenti.polito.it', 'Claudia', 'Marino', 'Italy', 'Bachelor', 'linkedin.com/in/claudiamarino', 's234568', 'Biomedical Engineering', 12, '2023-05-15 13:30:00+02'::timestamptz, NULL, '{"drive": ["heads", "leads", "general"], "wiki": ["general"]}'),
('dddddddd-dddd-dddd-dddd-dddddddddddd', 'chiara.verdi@studenti.polito.it', 'Chiara', 'Verdi', 'Italy', 'Master', 'linkedin.com/in/chiaraverdi', 's678902', 'Biomedical Engineering', NULL, '2023-03-05 10:30:00+01'::timestamptz, NULL, '{"drive": ["heads", "leads", "general"], "wiki": ["general"]}'),
('eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee', 'davide.marino@studenti.polito.it', 'Davide', 'Marino', 'Italy', 'Bachelor', 'linkedin.com/in/davidemarino', 's789013', 'Aerospace Engineering', NULL, '2023-03-10 13:15:00+01'::timestamptz, NULL, '{"drive": ["heads", "leads", "general"], "wiki": ["general"]}');

...
TRUNCATE members, users, departments, divisions, roles, orders, apply_positions, applications, scopes, faqs RESTART IDENTITY CASCADE;
...
INSERT INTO faqs (page, question, answer, display_order) VALUES
-- Apply page FAQ
('apply', 'How can I join the Team?', 'If there are open positions, there is the possibility of joining the Team. More details can be found by reading the open positions'' descriptions and apply procedures. The main recruitment process is generally held at the beginning of the academic year, but some positions might be open in other time periods too: look out for any updates on our social media and on our website.', 1),
('apply', 'Are there any requirements for joining the team?', 'Candidates must have time to dedicate to our projects, and an intermediate English proficiency level is preferred. We accept all PoliTo students regardless of program and year (undergraduate, graduate and PhD).', 2),
('apply', 'Can I join as a first-year student?', 'Yes, and we encourage you to! Theoretical knowledge and previous experience are appreciated, but they are not everything. Young and motivated students can learn and acquire real experience while working on our projects. As of Summer 2023, more than half of the Team''s members are Bachelor''s students, and many of them are first-year students!', 3),
('apply', 'Can I join the team as an international student?', 'Of course! As of Summer 2023, more than 25% of the Team''s members are international students. The selection process is the same for international and Italian students. As for any other student, good English knowledge is preferred. Italian language proficiency is not required, but appreciated.', 4),
('apply', 'Can I join the Team with a low level English proficiency?', 'The Team''s official language is English, and it is preferred that candidates have at least an intermediate language proficiency. Candidates with advanced English proficiency will have an advantage. Exceptions can be made for candidates with a particular set of skills or with important prior experience.', 5),
('apply', 'How much time do I need to put into the team every week?', 'There is not a rule for how much time you need to put in. There can be weeks where you will not work at all, but there will be days where you will need to work many hours. The Team is young and does not have a large number of members, so it is expected that the members of the Team put a considerable amount of work into our projects. In general, we expect that students can provide at the very least 6 hours of work for the Team per week. Exceptions can be made for particular positions, such as those which require particular skills or prior experience.', 6),
('apply', 'Can I join the Team if I am not an engineering student?', 'Yes, the Team accepts students coming from all programs offered at Politecnico. There are many positions available in the Team, especially in the Operations subteam, which are suited also for students coming from non-engineering programs.', 7),
('apply', 'Do you recruit only aerospace engineering students?', 'Of course not! Even if as of now the majority of the Team''s members come from the aerospace engineering program (around 68% as of Fall 2022), some of the Team''s positions are suited for students of the computer science, electronic, mechanical, management, or energy engineering programs, as well as many others. Furthermore, due to competition, the acceptance rate for aerospace engineering students is probably going to be lower than the one for students coming from other programs. This means that if you do not study aerospace engineering, you might face less competition in your application for certain positions than your aerospace engineering colleagues.', 8),
('apply', 'What is the acceptance rate onto the team?', 'Fall 2022 was the first general recruitment of the Team and we had an acceptance rate of around 15%. As much as we would love to accept every application, the Team can not manage the work of hundreds of members. Do not let this discourage you: we are always looking for motivated and talented young students.', 9),
('apply', 'Do you recruit at the beginning of the 2nd semester?', 'We do not know yet, but it is unlikely. Training new members takes time, and if students join in the winter semester they will start working towards the end of the academic year, which is not ideal. Students could be recruited at the beginning of the 2nd semester if they possess a particular set of skills or experience which matches the Team''s needs.', 10),
('apply', 'Can I join the Team if I am not a Politecnico di Torino student, or if I am a high school student?', 'PoliTo Rocket Team is a student team which gets its resources from the Dept. of Mechanical and Aerospace engineering of Politecnico di Torino. For this reason, we can''t accept students outside Politecnico. However, it is possible to cooperate and work together on some particular projects. If you are working on a rocketry-related project and you want to collaborate with us, contact us.', 11),

-- Home page FAQ
('home', 'What is PoliTo Rocket Team?', 'PoliTo Rocket Team is a student organization at Politecnico di Torino dedicated to designing, building, and launching rockets. We participate in international competitions and develop cutting-edge aerospace technology.', 1),
('home', 'What projects does the team work on?', 'We work on various rocket projects including liquid and solid propulsion systems, recovery systems, avionics, structures, and ground support equipment. Our team participates in international competitions like the European Rocketry Challenge.', 2),
('home', 'How is the team structured?', 'The team is organized into several departments: Propulsion, Structures, Aerodynamics, Recovery, Controls and Systems, Electronics, Operations, and Research & Development. Each department has divisions focusing on specific technical areas.', 3),
('home', 'Where can I follow the team''s activities?', 'You can follow us on our social media channels including Instagram, LinkedIn, Facebook, and YouTube. We regularly post updates about our projects, tests, and events.', 4),
('home', 'Does the team offer workshops or educational events?', 'Yes! We organize workshops, seminars, and outreach events to share our knowledge with the community and inspire interest in aerospace engineering. Check our social media for upcoming events.', 5),

-- Account page FAQ
('account', 'How do I update my profile information?', 'You can update your profile information by navigating to the Profile Settings section in your account dashboard. Make sure to save your changes before leaving the page.', 1),
('account', 'How do I access team resources like Drive and Wiki?', 'Team resources are accessible through the links provided in your account dashboard. Your access permissions are managed by team leads and will appear in your profile once granted.', 2),
('account', 'What should I do if I need to take a leave of absence?', 'If you need to take a leave of absence, please contact your division lead or department head as soon as possible. They will help you with the necessary procedures and documentation.', 3),
('account', 'How do I report my working hours?', 'Working hours can be logged through the team management system. Contact your division lead if you need help accessing the time tracking tools.', 4),
('account', 'Who should I contact if I have technical issues with the platform?', 'For technical issues with the website or platform, please contact the IT division through the Communications channel or email the development team directly.', 5);
